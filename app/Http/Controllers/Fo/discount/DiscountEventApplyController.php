...
class DiscountEventApplyController extends Controller
{
    private OrderRepository $orderRepository;
    private DiscountCostumerRepository $d_customer_repository;
    protected $data = array();

    public function __construct(OrderRepository $orderRepository, DiscountCostumerRepository $d_customer_repository)
    {
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->back()->with('error', 'Coupon discount tidak tersedia');
        }
    }
