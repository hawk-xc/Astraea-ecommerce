            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center pb-3">
                        ...
                        <a href="{{ route('discount.create') }}" class="btn bg-gradient-primary float-end">Tambah Data</a>
                    </div>
                    <div class="card-body table-responsive">
                        <table class="table table-stripe discount_table">
                            <thead>
                                <tr>
                                    <th class="text-center font-weight-bold text-primary">No</th>
                                    <th class="font-weight-bold text-primary">Nama Discount</th>
                                    <th class="font-weight-bold text-primary">Waktu</th>
                                    <th class="font-weight-bold text-primary">Status</th>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '#deleteRow', function(event) {
                ...
                console.log($('.discount_table tr.active'));
