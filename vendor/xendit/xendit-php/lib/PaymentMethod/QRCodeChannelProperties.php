...
/**
 * QRCodeChannelProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class QRCodeChannelProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QRCodeChannelProperties';
    ...
    */
     ...
     * Sets qr_string
     *
     * @param string|null $qr_string QR string to be rendered for display to end users. QR string to image rendering are commonly available in software libraries (e.g Nodejs, PHP, Java)
     *
     * @return self
     */
