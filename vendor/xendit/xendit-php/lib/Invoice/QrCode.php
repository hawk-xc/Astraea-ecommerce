...
class QrCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'qr_code_type' => '\Xendit\Invoice\QrCodeType'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['qr_code_type'] === null) {
            $invalidProperties[] = "'qr_code_type' can't be null";
        }
     ...
     * Sets qr_code_type
     *
     * @param \Invoice\QrCodeType $qr_code_type qr_code_type
     *
     * @return self
     */
