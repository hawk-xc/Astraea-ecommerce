...
/**
 * GetPayouts200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class GetPayouts200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPayouts_200_response_data_inner';
    ...
    */
    ...
    public function setReferenceId($reference_id)
    {
        ...
        if ((mb_strlen($reference_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference_id when calling GetPayouts200ResponseDataInner., must be bigger than or equal to 1.');
        }
