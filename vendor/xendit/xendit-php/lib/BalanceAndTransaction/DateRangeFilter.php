...
/**
 * DateRangeFilter Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class DateRangeFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DateRangeFilter';
    ...
    */
     ...
     * Sets gte
     *
     * @param \DateTime|null $gte Start time of transaction. If not specified will list all dates.
     *
     * @return self
     */
     ...
     * Sets lte
     *
     * @param \DateTime|null $lte End time of transaction. If not specified will list all dates.
     *
     * @return self
     */
