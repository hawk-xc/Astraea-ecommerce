            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center pb-3">
                        ...
                        <a href="{{ route('certificate.create') }}" class="btn bg-gradient-primary float-end">Tambah Data</a>
                    </div>
                    <div class="card-body table-responsive">
                        <table class="table table-stripe certificate_table">
                            <thead>
                                <tr>
...
@push('footer_script')
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.certificate_table').DataTable({
                language: {
                    paginate: {
                        next: "›",
                        previous: "‹"
