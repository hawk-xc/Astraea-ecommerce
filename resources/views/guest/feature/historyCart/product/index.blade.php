                                    ...
                                    <table class="total-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="total-data">
                                                ...
                                                <td>
                                                    {{ $data['order']['shippingData']->districtData['province'] }},
                                                    {{ $data['order']['shippingData']->districtData['type'] }}
                                                    {{ $data['order']['shippingData']->districtData['name'] }}, <br>
                                                    {{ $data['order']['address'] }}
                                                </td>
                                            </tr>
                                        </tbody>
                                                        ...
                                                        <tr class="table-body-row">
                                                            @if ($data['order']['status'] == 'PENDING')
                                                                <td class="product-remove">
                                                                    <form
                                                                        action="{{ route('fo.cart-product.destroy', $order['id']) }}"
                                                                        method="post">
                                                                        @method('delete')
                                                                        @csrf
                                                            ...
                                                            @endif
                                                            <td class="product-name">{{ $order['product_data']['name'] }}
                                                            </td>
                                                            <td class="product-price" id="price_{{ $order['id'] }}">Rp.
                                                                {{ number_format($order['product_data']['price'], 0, ',', '.') }}
                                                            </td>
                                                                    ...
                                                                    <form action="#">
                                                                        <div class="form-group"
                                                                            ...
                                                                            <input type="text" name="quantity"
                                                                                ...
                                                                                class="input-angka cart-input-quantity"
                                                                                maxlength="6"
                                                            ...
                                                            <td class="product-total"
                                                                id="price_sub_total_product_{{ $order['id'] }}">Rp.
                                                                {{ number_format($order['sub_total_price'], 0, ',', '.') }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                    ...
                    <div class="total-section">
                        ...
                        <div class="cart-buttons">
                            ...
                            @elseif($data['order']['status'] == 'UNPAID')
                                <a href="{{ $data['order']['payment_link'] }}" target="__blank"
                                    class="boxed-btn black">Payment</a>
                            @endif
                        </div>
                    </div>
                </div>
