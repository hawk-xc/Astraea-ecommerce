 ...
 *
 * @category Class
 * @description An object representing payment details.
 * @package  Xendit
...
class PaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets receipt_id
     *
     * @param string|null $receipt_id The unique identifier or reference ID associated with the payment receipt.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source The source or method of payment.
     *
     * @return self
     */
