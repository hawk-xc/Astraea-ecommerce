					...
					<div class="testimonial-sliders">
						...
						<div class="single-testimonial-slider">
							<div class="client-meta">
								<h3>{{ $testimoni['customerData']['name'] }} <span>@ {{ $testimoni['customerData']['username'] }}</span></h3>
				...
				<div class="col-lg-12">
					<div class="logo-carousel-inner">
						...
						<div class="single-logo-item">
							<a href="{{ route('fo.certificate.show', $certificate['id']) }}"><img src="{{ asset('storage/' . $certificate['image']) }}" alt=""></a>
						</div>
						@endforeach
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="logo-carousel-inner">
						...
						<div class="single-logo-item">
							<a href="{{ route('fo.partner.show', $partner['id']) }}"><img src="{{ asset('storage/' . $partner['image']) }}" alt=""></a>
						</div>
						@endforeach
					</div>
				</div>
