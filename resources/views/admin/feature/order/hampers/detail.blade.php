                        ...
                        <table class="table table-stripe">
                            ...
                            <tr class="ps-3 pt-0 pb-0 align-middle text-sm font-weight-normal">
                                ...
                                <td class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="{{ route('order_hampers.edit',$data['id']) }}" class="btn bg-gradient-info btn-tooltip">
                                            <i class="bi bi-pencil-square"></i></a>
                                        <a href="{{ route('resi_hampers.print',$data['id']) }}" target="__blank" class="btn bg-gradient-primary btn-tooltip">
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.order_detail_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('order_hampers.detail', $data['id']) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
                    {
                        data: 'hampers_data.name',
                        name: 'hampers_data.name'
                    },
                    {
                        data: 'price',
                        name: 'price'
