...
/**
 * PaymentRequestParametersChannelProperties Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentRequestParametersChannelProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRequestParameters_channel_properties';
    ...
    */
    ...
    public function setSuccessReturnUrl($success_return_url)
    {
        ...
        if ((!preg_match("/^\\S{1,255}:\/\/\\S{0,1000}$/", $success_return_url))) {
            throw new \InvalidArgumentException("invalid value for \$success_return_url when calling PaymentRequestParametersChannelProperties., must conform to the pattern /^\\S{1,255}:\/\/\\S{0,1000}$/.");
        }
    ...
    public function setFailureReturnUrl($failure_return_url)
    {
        ...
        if ((!preg_match("/^\\S{1,255}:\/\/\\S{0,1000}$/", $failure_return_url))) {
            throw new \InvalidArgumentException("invalid value for \$failure_return_url when calling PaymentRequestParametersChannelProperties., must conform to the pattern /^\\S{1,255}:\/\/\\S{0,1000}$/.");
        }
    ...
    public function setCancelReturnUrl($cancel_return_url)
    {
        ...
        if ((!preg_match("/^\\S{1,255}:\/\/\\S{0,1000}$/", $cancel_return_url))) {
            throw new \InvalidArgumentException("invalid value for \$cancel_return_url when calling PaymentRequestParametersChannelProperties., must conform to the pattern /^\\S{1,255}:\/\/\\S{0,1000}$/.");
        }
     ...
     * Sets cvv
     *
     * @param string|null $cvv Three digit code written on the back of the card (usually called CVV/CVN).
     *
     * @return self
     */
