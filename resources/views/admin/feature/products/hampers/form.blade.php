                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3-select" id="role">
                                            ...
                                            <div class="input-group">
                                                <select name="category_id" id="category_id" class="form-control categories-data">
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3-select" id="role">
                                            ...
                                            <div class="input-group">
                                                <select name="subcategory_id" id="subcategory_id" class="form-control subcategories-data">
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="text" name="stock" class="input-angka form-control bg-white" type="text"
                                                placeholder="Jumlah Barang" value="{{ old('stock', isset($data) ? $data['stock'] : '') }}">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Berat Barang</label>
                                            <div class="input-group">
                                                <input id="text" name="weight" class="input-angka form-control bg-white" type="text"
                                                    placeholder="Berat Barang" value="{{ old('weight', isset($data) ? $data['weight'] : '') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea rows="7" id="description" name="description" class="form-control" type="text"
                                                placeholder="Silahkan masukkan Deskrisi Barang">{{ old('description', isset($data) ? $data['description'] : '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input id="hpp" name="hpp" class="input-angka form-control bg-white" type="text"
                                                placeholder="Harga Pokok Penjualan" value="{{ old('hpp', isset($data) ? $data['hpp'] : '') }}">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Margin Keuntungan</label>
                                            <div class="input-group">
                                            <input id="margin" name="margin" class="percentage-input form-control bg-white" type="text"
                                                placeholder="Harga Jual" value="{{ old('margin', isset($data) ? $data['margin'] : '') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                            <input id="b_layanan" name="b_layanan" class="percentage-input form-control bg-white" type="text"
                                                placeholder="Biaya Layanan" value="{{ old('b_layanan', isset($data) ? $data['b_layanan'] : '') }}">
                                            <span class="input-group-text ">%</span>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input id="harga_jual" name="price" class="input-angka form-control bg-white" type="text"
                                                placeholder="Harga Jual" value="{{ old('price', isset($data) ? $data['price'] : '') }}">
                                            </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="frn float-end">
                                                <input id="pos-front" name="pos-front" value="{{ isset($data_gambar['front'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                ...
                                                <button id="remove-front" type="button" class="btn btn-outline-danger m-0"
                                                    onclick="remove_photo('remove-front','front','input-front', 'pos-front')" {{ isset($data_gambar['front'][0]['name']) ? '' : 'hidden' }}
                                                    >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="bck float-end">
                                                <input id="pos-back" name="pos-back" type="text" value="{{ isset($data_gambar['back'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-back" type="button"
                                                    ...
                                                    onclick="remove_photo('remove-back','back','input-back','pos-back')" {{ isset($data_gambar['back'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="lft float-end">
                                                <input id="pos-left" name="pos-left" type="text" value="{{ isset($data_gambar['left'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-left" type="button"
                                                    class="btn btn-outline-danger m-0 "
                                                    onclick="remove_photo('remove-left','left','input-left', 'pos-left')" {{ isset($data_gambar['left'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="rgt float-end">
                                                <input id="pos-right" name="pos-right" type="text" value="{{ isset($data_gambar['right'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-right" type="button"
                                                    class="btn btn-outline-danger m-0 "
                                                    onclick="remove_photo('remove-right','right','input-right', 'pos-right')" {{ isset($data_gambar['right'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="dtl1 float-end">
                                                <input id="pos-detail1" name="pos-detail1" type="text" value="{{ isset($data_gambar['detail1'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-detail1" type="button"
                                                    class="btn btn-outline-danger m-0 "
                                                    onclick="remove_photo('remove-detail1','detail1','input-detail1', 'pos-detail1')" {{ isset($data_gambar['detail1'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="dtl2 float-end">
                                                <input id="pos-detail2" name="pos-detail2" type="text" value="{{ isset($data_gambar['detail2'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-detail2" type="button"
                                                    class="btn btn-outline-danger m-0 "
                                                    onclick="remove_photo('remove-detail2','detail2','input-detail2', 'pos-detail2')" {{ isset($data_gambar['detail2'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="dtl3 float-end">
                                                <input id="pos-detail3" name="pos-detail3" type="text" value="{{ isset($data_gambar['detail3'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-detail3" type="button"
                                                    class="btn btn-outline-danger m-0 "
                                                    onclick="remove_photo('remove-detail3','detail3','input-detail3', 'pos-detail3')" {{ isset($data_gambar['detail3'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="dtl4 float-end">
                                                <input id="pos-detail4" name="pos-detail4" type="text" value="{{ isset($data_gambar['detail4'][0]['name']) ? 'old_true' : '' }}" readonly hidden>
                                                <div
                                                    class="mb-3 mt-3 me-1 w-auto fileUpload btn btn-outline-primary col-md-6">
                                                    <span><i class="bi bi-upload"></i></span>
                                                ...
                                                <button id="remove-detail4" type="button"
                                                    class="btn btn-outline-danger m-0 "
                                                    onclick="remove_photo('remove-detail4','detail4','input-detail4', 'pos-detail4')" {{ isset($data_gambar['detail4'][0]['name']) ? '' : 'hidden' }}>
                                                    <i class="bi bi-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer">
                            <div class="float-end">
                                <a href="{{ route('hampers.index') }}" type="submit"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.categories-data').on('change', function() {
                ...
                var subCategoryUrl = "{{ route('subcategories.data.categori')}}?category_id=" + categoryId;
                var selectedSubCategoryIds = [
                    @if(isset($data['subcategory_id']))
                        '{{ $data["subcategory_id"] }}',
                    @endif
                ];
                populateSelect2(subCategorySelector, subCategoryUrl, selectedSubCategoryIds, "Pilih Subkategori");
            });
        });
        ...
        function hitungHargaJual() {
            ...
            var margin = parseFloat(document.getElementById('margin').value) || 0; // Mengambil nilai margin atau 0 jika kosong
            var biayaLayanan = parseFloat(document.getElementById('b_layanan').value) || 0; // Mengambil nilai biaya layanan atau 0 jika kosong
            
                if (hpp !== 0 && margin !== 0 && biayaLayanan !== 0) {
                    var hargaJual = hpp / (1 - (margin / 100 + biayaLayanan / 100));
                    document.getElementById('r_h_jual').innerText = "Rekomendasi Harga Jual Rp. " + hargaJual.toFixed(2) + " atau di atasnya";
                } else {
