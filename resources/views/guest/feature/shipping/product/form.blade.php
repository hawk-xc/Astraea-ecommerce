                            ...
                            <div class="card single-accordion">
                                ...
                                <div class="card-body">
                                    <div class="billing-address-form">
                                        <form method="post"
                                            action="{{ route('fo.shipping-product.update', $data['id_order']) }}">
                                            @method('put')
                                            @csrf
                                                ...
                                                @foreach ($data['rajaongkir'] as $result)
                                                    ...
                                                    @foreach ($result['costs'] as $cost)
                                                        <div class="container mt-4">
                                                            <div class="form-row">
                                                                <div class="radio-col">
                                                                    <input type="radio" id="ongkir_{{ $loop->index }}"
                                                                        name="ongkir" value="{{ $loop->index }}">
                                                                </div>
                                                                <label for="ongkir_{{ $loop->index }}"
                                                                    class="label-col pt-2">
