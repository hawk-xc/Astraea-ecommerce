...
/**
 * CreatePaymentMethod409Response Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class CreatePaymentMethod409Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createPaymentMethod_409_response';
    ...
    public const ERROR_CODE_PAYMENT_METHOD_ALREADY_ACTIVE = 'PAYMENT_METHOD_ALREADY_ACTIVE';
    public const ERROR_CODE_PAYMENT_METHOD_ALREADY_FAILED = 'PAYMENT_METHOD_ALREADY_FAILED';
    ...
    public function getErrorCodeAllowableValues()
    {
        return [
            ...
            self::ERROR_CODE_PAYMENT_METHOD_ALREADY_FAILED,
