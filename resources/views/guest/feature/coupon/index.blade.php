                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            @foreach ($data['coupon']['datas'] as $coupon)
                                <div class="col-md-4 my-3">
                                    <div class="card">
                                        <div class="image-top-coupon">
                                            <img src="{{ asset('storage/' . $coupon['discountData']['image_banner']) }}"
                                                class="coupon-img" alt="">
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    @if ($coupon['discountData']['id'] != 'DIS-20240000000000000001')
                                                        <p class="mb-0 coupon-header">Valid Until <i
                                                                class="bi bi-calendar3"></i>
                                                            {{ $coupon['discountData']['end_date'] }} <i
                                                                class="bi bi-clock"></i>
                                                            {{ $coupon['discountData']['end_time'] }}</p>
                                                    @else
                                                        <p class="mb-0 coupon-header">Diskon Pelanggan Baru</p>
                                                    @endif
                                                    <div class="badge bg-success text-white p-2">
                                                        {{ $coupon['discountData']['discount_amount'] }}<i
                                                            class="bi bi-percent"></i> OFF
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modal_{{ $loop->index }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="image-modal-top">
                                                    <img src="{{ asset('storage/' . $coupon['discountData']['image_banner']) }}"
                                                        class="coupon-img-modal" alt="">
                                                    <div class="container my-3">
                                                        @if ($coupon['discountData']['id'] != 'DIS-20240000000000000001')
                                                            <p><strong>Valid Until:
                                                                </strong>{{ $coupon['discountData']['end_date'] }}
                                                                {{ $coupon['discountData']['end_time'] }}</p>
                                                        @endif
                                                        <p><strong>Discount Amount:
                                                            </strong>{{ $coupon['discountData']['discount_amount'] }}%</p>
                                                        <p><strong>Discount Code:
                                                            </strong>{{ $coupon['discountData']['code_discount'] }}</p>
                                                        <p><strong>Description:
                                                            </strong>{{ $coupon['discountData']['description_discount'] }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
