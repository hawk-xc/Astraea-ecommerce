				...
				<div class="main-menu-wrap">
					...
					<nav class="main-menu pt-3">
						<ul>
							...
							<li class="{{ $ref['title'] == 'Shop Product' || $ref['title'] == 'Shop Hampers'?'current-list-item':'' }}">
								<a href="#">Shop</a>
								<ul class="sub-menu">
							...
							<li class="{{ $ref['title'] == 'Profile' || $ref['title'] == 'Cart Hampers' || $ref['title'] == 'Cart Product'?'current-list-item':'' }}">
