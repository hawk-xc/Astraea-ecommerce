					                    ...
					                    <div class="row">
					                    	<div class="col-md-6">					                    		
							                    <p>
							                    	...
							                    	<input type="text" id="nama" name="name" placeholder="Nama" value="{{ auth()->guard('customer')->user()->name }}" required>
							                    </p> <!-- Input untuk nama lengkap -->
							                    <p>
							                    	<label for="nama_pengguna">Nama pengguna</label>
							                    	<input type="text" id="nama_pengguna" name="username" placeholder="Nama Pengguna" value="{{ auth()->guard('customer')->user()->username }}" required>
							                    </p> <!-- Input untuk nama lengkap -->
							                    <p>
							                    	<label for="mail">Email</label>
							                    	<input type="email" id="mail" name="email" placeholder="Email" value="{{ auth()->guard('customer')->user()->email }}" required>
							                    </p>
							                    <p>
							                    	<label for="phone">No Telepon</label>
							                    	<input type="text" id="phone" name="phone" placeholder="No Telepon" value="{{ auth()->guard('customer')->user()->phone }}" required>
							                    </p>
							                    <p>
							                    	<label for="wa">No Whatsapp</label>
							                    	<input type="text" id="wa" name="wa" placeholder="No Whatsapp" value="{{ auth()->guard('customer')->user()->wa }}" required>
							                    </p>
					                    	</div>
					                    	<div class="col-md-6">					                    		
							                    <p>
							                    	<label for="jenis_kelamin">Jenis Kelamin</label>
							                    	<select id="jenis_kelamin" name="jenis_kelamin" class="jankel" placeholder="jenis kelamin" required>
							                    		<option value="" selected disabled>Pilih Jenis Kelamin</option>
							                    		<option value="male" {{ auth()->guard('customer')->user()->jenis_kelamin == 'male'?'selected':''}}>Laki Laki</option>
							                    		<option value="female" {{ auth()->guard('customer')->user()->jenis_kelamin == 'female'?'selected':''}}>Perempuan</option>
							                    	</select>
							                    </p>
							                    <p>
							                    	<label for="tgl_lahir">Tanggal Lahir</label>
							                    	<input type="text" id="tgl_lahir" name="tgl_lahir" class="tanggal-lahir" placeholder="Tanggal Lahir" value="{{ auth()->guard('customer')->user()->tgl_lahir }}"  required>
							                    </p>
							                    <p>
