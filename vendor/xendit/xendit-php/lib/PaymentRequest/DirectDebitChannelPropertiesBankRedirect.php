...
/**
 * DirectDebitChannelPropertiesBankRedirect Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectDebitChannelPropertiesBankRedirect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectDebitChannelPropertiesBankRedirect';
    ...
    */
     ...
     * Sets mobile_number
     *
     * @param string|null $mobile_number Mobile number of the customer that is registered to channel
     *
     * @return self
     */
