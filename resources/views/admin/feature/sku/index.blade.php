            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center pb-3">
                        ...
                        <a href="{{ route('sku.create') }}" class="btn bg-gradient-primary float-end">Tambah Data</a>
                    </div>
                    <div class="card-body table-responsive">
                        <table class="table table-stripe sku-table">
                            <thead>
                                <tr>
                                    <th class="text-center font-weight-bold text-primary">No</th>
                                    <th class="font-weight-bold text-primary">Kode</th>
                                    <th class="font-weight-bold text-primary">Nama</th>
                                    <th class="text-center w-1 font-weight-bold text-primary">Aksi</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '#deleteRow', function(event) {
                ...
                console.log($('.sku-table tr.active'));
                event.preventDefault();
                $.confirm({
                    icon: 'fa fa-warning',
                    title: 'Yakin Hapus Data',
                    content: 'SKU ' + $(this).data('message') + ' Akan di hapus secara permanen',
                    type: 'orange',
                    typeAnimated: true,
                    animationSpeed: 500,
                    closeAnimation: 'zoom',
