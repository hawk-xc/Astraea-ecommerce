...
/**
 * PaymentMethodAuthParameters Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodAuthParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodAuthParameters';
    ...
    */
    ...
    public function setAuthCode($auth_code)
    {
        ...
        if ((mb_strlen($auth_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $auth_code when calling PaymentMethodAuthParameters., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($auth_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $auth_code when calling PaymentMethodAuthParameters., must be bigger than or equal to 6.');
        }
