...
class DirectDebit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'channel_code' => '\Xendit\PaymentRequest\DirectDebitChannelCode',
        'channel_properties' => '\Xendit\PaymentRequest\DirectDebitChannelProperties',
        'type' => '\Xendit\PaymentRequest\DirectDebitType',
        'bank_account' => '\Xendit\PaymentRequest\DirectDebitBankAccount',
        'debit_card' => '\Xendit\PaymentRequest\DirectDebitDebitCard'
    ];
    ...
    */
     ...
     * Gets channel_code
     *
     * @return \PaymentRequest\DirectDebitChannelCode
     */
     ...
     * Sets channel_code
     *
     * @param \PaymentRequest\DirectDebitChannelCode $channel_code channel_code
     *
     * @return self
     */
     ...
     *
     * @return \PaymentRequest\DirectDebitChannelProperties
     */
     ...
     *
     * @param \PaymentRequest\DirectDebitChannelProperties $channel_properties channel_properties
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \PaymentRequest\DirectDebitType
     */
     ...
     * Sets type
     *
     * @param \PaymentRequest\DirectDebitType $type type
     *
     * @return self
     */
     ...
     * Gets bank_account
     *
     * @return \PaymentRequest\DirectDebitBankAccount|null
     */
     ...
     * Sets bank_account
     *
     * @param \PaymentRequest\DirectDebitBankAccount|null $bank_account bank_account
     *
     * @return self
     */
     ...
     * Gets debit_card
     *
     * @return \PaymentRequest\DirectDebitDebitCard|null
     */
     ...
     * Sets debit_card
     *
     * @param \PaymentRequest\DirectDebitDebitCard|null $debit_card debit_card
     *
     * @return self
     */
    public function setDebitCard($debit_card)
    {
        if (is_null($debit_card)) {
            array_push($this->openAPINullablesSetToNull, 'debit_card');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('debit_card', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
