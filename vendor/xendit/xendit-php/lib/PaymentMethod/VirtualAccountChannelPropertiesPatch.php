...
/**
 * VirtualAccountChannelPropertiesPatch Class Doc Comment
 *
 * @category Class
 ...
 */
class VirtualAccountChannelPropertiesPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualAccountChannelPropertiesPatch';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['suggested_amount']) && ($this->container['suggested_amount'] < 1)) {
            $invalidProperties[] = "invalid value for 'suggested_amount', must be bigger than or equal to 1.";
        }
    ...
    public function setSuggestedAmount($suggested_amount)
    {
        ...
        if (($suggested_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $suggested_amount when calling VirtualAccountChannelPropertiesPatch., must be bigger than or equal to 1.');
        }
