				...
				<div class="col-lg-8">
					<div class="single-article-section">
						<div class="single-article-text">
							<div class="single-artcile-bg" id="articleBackground"></div>
							<p class="blog-meta">
...
<script type="text/javascript">
	document.addEventListener("DOMContentLoaded", function() {
	    var articleBackground = document.querySelector(".single-artcile-bg");
	    articleBackground.style.backgroundImage = "url({{ asset('storage/' .  $data['event']->cover_image) }})";
	});
</script>
@endpush