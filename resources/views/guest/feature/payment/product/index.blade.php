			...
			<div class="row">
						...
						<div class="accordion" id="accordionExample">
						  ...
						  <div class="card single-accordion">
						    ...
						    <div>
						      <div class="card-body">
					       	 <div class="billing-address-form">
					        	<form method="post" action="{{ route('fo.shipping-product.cekk', $data['id_nota']) }}">
					        		@csrf
					        		<p>
				                    ...
				                    <p>
				                    	@php
										    $shippingName = old('expedisi', $data['shipping']['name'] ?? '');
										@endphp
				...
				<div class="col-lg-4">
					...
					<div class="coupon-section">
						<h3>Checkout</h3>
						<div class="coupon-form-wrap">
							<form action="{{ route('product-payment.create', $data['id_nota']) }}" method="post" target="_blank">
				        		@csrf
					        	<p>
...
@push('footer_script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var selectedCategoryIds = [ '{{ old('district_id', isset($data['shipping']['destination']) ? $data['shipping']['destination'] : $data['id_destination']) }}', ];
