...
/**
 * CaptureParameters Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class CaptureParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptureParameters';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['capture_amount'] === null) {
            $invalidProperties[] = "'capture_amount' can't be null";
        }
     ...
     * Sets capture_amount
     *
     * @param float $capture_amount capture_amount
     *
     * @return self
     */
    public function setCaptureAmount($capture_amount)
    {
        if (is_null($capture_amount)) {
            throw new \InvalidArgumentException('non-nullable capture_amount cannot be null');
        }
