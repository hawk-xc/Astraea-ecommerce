...
/**
 * OverTheCounterChannelProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class OverTheCounterChannelProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OverTheCounterChannelProperties';
    ...
    */
     ...
     * Sets payment_code
     *
     * @param string|null $payment_code The payment code that you want to assign, e.g 12345. If you do not send one, one will be picked at random.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at The time when the payment code will be expired. The minimum is 2 hours and the maximum is 9 days for 7ELEVEN. Default expired date will be 2 days from payment code generated.
     *
     * @return self
     */
