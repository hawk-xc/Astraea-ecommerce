...
/**
 * AccountEwallet Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class AccountEwallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountEwallet';
    ...
    */
     ...
     *
     * @param string|null $account_holder_name Name of account holder as per the bank records. Needs to match the registered account name exactly.
     *
     * @return self
     */
