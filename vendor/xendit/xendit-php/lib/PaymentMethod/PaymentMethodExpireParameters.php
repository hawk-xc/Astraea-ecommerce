...
/**
 * PaymentMethodExpireParameters Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodExpireParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodExpireParameters';
    ...
    */
     ...
     *
     * @param string|null $success_return_url URL where the end customer is redirected if the unlinking authorization is successful.
     *
     * @return self
     */
     ...
     *
     * @param string|null $failure_return_url URL where the end customer is redirected if the unlinking authorization is failed.
     *
     * @return self
     */
