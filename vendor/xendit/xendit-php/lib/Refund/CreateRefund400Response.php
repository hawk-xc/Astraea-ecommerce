...
/**
 * CreateRefund400Response Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class CreateRefund400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createRefund_400_response';
    ...
    public const ERROR_CODE_INELIGIBLE_TRANSACTION = 'INELIGIBLE_TRANSACTION';
    public const ERROR_CODE_INSUFFICIENT_BALANCE = 'INSUFFICIENT_BALANCE';
    public const ERROR_CODE_MAXIMUM_REFUND_AMOUNT_REACHED = 'MAXIMUM_REFUND_AMOUNT_REACHED';
    ...
    public function getErrorCodeAllowableValues()
    {
        return [
            ...
            self::ERROR_CODE_MAXIMUM_REFUND_AMOUNT_REACHED,
