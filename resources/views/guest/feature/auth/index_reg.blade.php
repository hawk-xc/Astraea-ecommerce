                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <p>
                                                        ...
                                                        <input type="text" id="phone" name="phone"
                                                            class="input-angka" placeholder="No Telepon"
                                                            value="{{ old('phone') }}" required>
                                                    </p>
                                                    <p>
                                                        <label for="wa">No Whatsapp</label>
                                                        <input type="text" id="wa" name="wa"
                                                            class="input-angka" placeholder="No Whatsapp"
                                                    ...
                                                    <p>
                                                        ...
                                                        <select id="phone" name="jenis_kelamin" class="jankel"
                                                            placeholder="No Telepon" value="{{ old('phone') }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="toggle-password input-group-text bi bi-eye"
                                                            onclick="togglePassword('cofmpass', this)"><i
                                                                class="ri-eye-off-line"></i></span>
                                                    </div>
                                                    </p>
                                                    <p>
                                                    ...
                                                    <p>Apakah Anda sudah mempunyai akun? <a
                                                            href="{{ route('loginf.customer') }}">masuk</a></p>
