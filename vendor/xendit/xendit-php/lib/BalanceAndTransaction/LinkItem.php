...
/**
 * LinkItem Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class LinkItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkItem';
    ...
    */
     ...
     * Sets href
     *
     * @param string $href URI of target, this will be to the next link.
     *
     * @return self
     */
     ...
     * Sets rel
     *
     * @param string $rel The relationship between source and target. The value will be `next`.
     *
     * @return self
     */
     ...
     * Sets method
     *
     * @param string $method The HTTP method, the value will be `GET`.
     *
     * @return self
     */
