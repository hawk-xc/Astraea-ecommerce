...
/**
 * VirtualAccountParameters Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class VirtualAccountParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualAccountParameters';
    ...
    */
    ...
    public function setMinAmount($min_amount)
    {
        ...
        if (!is_null($min_amount) && ($min_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_amount when calling VirtualAccountParameters., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxAmount($max_amount)
    {
        ...
        if (!is_null($max_amount) && ($max_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_amount when calling VirtualAccountParameters., must be bigger than or equal to 1.');
        }
