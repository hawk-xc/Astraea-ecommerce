...
class Ewallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ewallet_type' => '\Xendit\Invoice\EwalletType'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ewallet_type'] === null) {
            $invalidProperties[] = "'ewallet_type' can't be null";
        }
     ...
     * Sets ewallet_type
     *
     * @param \Invoice\EwalletType $ewallet_type ewallet_type
     *
     * @return self
     */
