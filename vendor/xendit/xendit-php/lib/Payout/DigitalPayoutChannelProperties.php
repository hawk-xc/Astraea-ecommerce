...
/**
 * DigitalPayoutChannelProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class DigitalPayoutChannelProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DigitalPayoutChannelProperties';
    ...
    protected static $openAPITypes = [
        ...
        'account_type' => '\Xendit\Payout\ChannelAccountType'
    ];
    ...
    */
     ...
     *
     * @param string|null $account_holder_name Registered account name
     *
     * @return self
     */
     ...
     * Sets account_number
     *
     * @param string $account_number Registered account number
     *
     * @return self
     */
     ...
     * Gets account_type
     *
     * @return \Payout\ChannelAccountType|null
     */
     ...
     * Sets account_type
     *
     * @param \Payout\ChannelAccountType|null $account_type account_type
     *
     * @return self
     */
