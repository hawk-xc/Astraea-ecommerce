...
/**
 * CaptureListResponse Class Doc Comment
 *
 * @category Class
 * @package  Xendit
 * @implements \ArrayAccess<string, mixed>
 */
class CaptureListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptureListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\Xendit\PaymentRequest\Capture[]',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PaymentRequest\Capture[] $data data
     *
     * @return self
     */
