...
class VirtualAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'max_amount' => 'float',
        'currency' => 'string',
        'channel_code' => '\Xendit\PaymentMethod\VirtualAccountChannelCode',
        'channel_properties' => '\Xendit\PaymentMethod\VirtualAccountChannelProperties',
        'alternative_display_types' => 'string[]',
        'alternative_displays' => '\Xendit\PaymentMethod\VirtualAccountAlternativeDisplay[]'
    ];
    ...
    */
    ...
    public function setMinAmount($min_amount)
    {
        ...
        if (!is_null($min_amount) && ($min_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_amount when calling VirtualAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxAmount($max_amount)
    {
        ...
        if (!is_null($max_amount) && ($max_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_amount when calling VirtualAccount., must be bigger than or equal to 1.');
        }
     ...
     * Gets channel_code
     *
     * @return \PaymentMethod\VirtualAccountChannelCode
     */
     ...
     * Sets channel_code
     *
     * @param \PaymentMethod\VirtualAccountChannelCode $channel_code channel_code
     *
     * @return self
     */
     ...
     *
     * @return \PaymentMethod\VirtualAccountChannelProperties
     */
     ...
     *
     * @param \PaymentMethod\VirtualAccountChannelProperties $channel_properties channel_properties
     *
     * @return self
     */
     ...
     *
     * @return \PaymentMethod\VirtualAccountAlternativeDisplay[]|null
     */
     ...
     *
     * @param \PaymentMethod\VirtualAccountAlternativeDisplay[]|null $alternative_displays alternative_displays
     *
     * @return self
     */
