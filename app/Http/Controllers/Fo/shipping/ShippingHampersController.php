...
class ShippingHampersController extends Controller
{
    ...
    public function __construct(ContactUsRepository $contactUsRepository, AboutUsRepository $aboutUsRepository, OrderHampersRepository $orderRepository, OrderHampersDetailRepository $orderDetailRepository, ShippingRepository $shippingRepository)
    {
        ...
        $this->data['view_directory'] = "guest.feature.shipping.hampers";
    }
