...
/**
 * InvoiceCallbackItem Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceCallbackItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceCallbackItem';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceCallbackItem., must be bigger than 0.');
        }
